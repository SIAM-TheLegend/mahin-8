  ...
  return (
    <nav className="flex items-center max-w-6xl mx-auto justify-between px-8 py-6 bg-white">
      ...
      <div className="flex items-center space-x-4">
        <Link onClick={() => setActiveTab("cart")} to="/dashboard" className="p-2 rounded-full bg-gray-300 transition duration-200">
          <ShoppingCart className="w-6 h-6 text-gray-900" />
        </Link>
        <Link onClick={() => setActiveTab("wishlist")} to="/dashboard" className="p-2 rounded-full bg-gray-300 transition duration-200">
